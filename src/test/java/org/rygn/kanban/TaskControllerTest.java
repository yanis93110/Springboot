...
public class TaskControllerTest extends ControllerTest {
	...
	public void testGetTask() throws Exception {
		...
		mvc.perform(get("/tasks/1")
			    ...
			    .andExpect(jsonPath("$.nbHoursForecast", is(0)))
			    .andExpect(jsonPath("$.nbHoursReal", is(0)))
			    .andExpect(jsonPath("$.status.label", is("TODO")))
			    .andExpect(jsonPath("$.type.label", is("FEATURE")))
			    .andExpect(jsonPath("$.developers[0].email", is("dev1@dev.dev")))
			    ;
	}
